...
/// 
/// let is_valid = verify_md5_string("hello world", "5d41402abc4b2a76b9719d911017c592");
/// assert!(is_valid);
/// ```
...
mod tests {
    ...
    #[test]
    fn test_md5_string() {
        assert_eq!(md5_string("hello world"), "5eb63bbbe01eeed093cb22bb8f5acdc3");
        assert_eq!(md5_string(""), "d41d8cd98f00b204e9800998ecf8427e");
        assert_eq!(md5_string("The quick brown fox jumps over the lazy dog"), "9e107d9d372bb6826bd81d3542a419d6");
    }
    ...
    fn test_verify_md5_string() {
        assert!(verify_md5_string("hello world", "5eb63bbbe01eeed093cb22bb8f5acdc3"));
        assert!(verify_md5_string("hello world", "5EB63BBBE01EEED093CB22BB8F5ACDC3")); // 大小写不敏感
